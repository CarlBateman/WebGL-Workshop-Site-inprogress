...
function init() {
  ...
  var cylinder = addCylinder(scene, 5, "imgs/inner.png");
  cylinder = addCylinder(scene, 10, "imgs/mid.png");
  cylinder = addCylinder(scene, 15, "imgs/outer.png");
  ...
  var render = function () {
    ...
    // update slice
    var pos = 0.5 - cross_section.position.x / 30;
    sliceMaterial.uniforms.pos.value = pos;
...
function addCrossSection(scene, size) {
  ...
  var material = new THREE.MeshBasicMaterial({ color: 0x888888, side: THREE.DoubleSide });//createEarthMaterial("../../imgs/earthmap2k.jpg");//
