...
function addClouds(scene) {
  ...
  loader.load("code/img/fair_clouds_1k.png", function (image) {
...
function createEarthMaterial() {
  ...
  var loader = new THREE.ImageLoader();
  loader.load("code/img/earthmap1k.jpg", function (image) {
  ...
  var loader = new THREE.ImageLoader();
  loader.load("code/img/earth_normalmap_flat2k.jpg", function (image) {
  ...
  var loader = new THREE.ImageLoader();
  loader.load("code/img/earthspec1k.jpg", function (image) {
