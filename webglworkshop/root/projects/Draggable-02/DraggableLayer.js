...
window.addEventListener('DOMContentLoaded', function () {
  (function (a, b) {
    ...
    (function () { // Create the dialog box markup
      ...
      //div.innerHTML = '<h3 class="dialog-title">&nbsp;</h3><a href="javascript:;" class="dialog-minmax" title="Minimize">&ndash;</a><div class="dialog-content">&nbsp;</div><div class="dialog-action"></div>';
